...
public class Panel extends JPanel {
    ...
    public Panel() {
        ...
        textbox.setBounds(1, 32, 390, 580);
        ...
        scroller.setBounds(1, 32, 390, 580);
        scroller.setVerticalScrollBarPolicy((JScrollPane.VERTICAL_SCROLLBAR_ALWAYS));

        scanbutton = new JButton("Scan");
        scanbutton.setBackground(new Color(59, 89, 182));
        scanbutton.setForeground(Color.WHITE);
        scanbutton.setFocusPainted(false);
        scanbutton.setFont(new Font("Tahoma", Font.BOLD, 12));
        scanbutton.setBounds(300, 1, 72, 30);

        addressbox = new JTextField();
        addressbox.setBounds(1, 1, 300, 30);
